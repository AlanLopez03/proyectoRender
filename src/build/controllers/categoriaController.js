...
class CategoriaController {
    ...
    listOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT * FROM categoria WHERE idCategoria = ?', [id]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //console.log(id)
            const resp = yield database_1.default.query("UPDATE categoria set ? WHERE idCategoria = ?", [req.body, id]);
            res.json(resp);
        });
    }
    delete(req, res) {
